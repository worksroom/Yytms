            ...
            form = $("#form2").ligerForm({
                ...
                tab:
                {
                    items : [
                        ...
                        {
                            title: '营业执照', fields: [
                                {display: "营业执照", width: 500, readonly: true, hideLabel: true, name: "licencePhone", newline: false, type: "text", afterContent: "<div><img style='width: 410px;height: 260px;' id='licencePhone_img'></img></div>"}
                            ]
                        }
                    ]
                }
