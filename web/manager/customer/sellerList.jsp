...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            window['g'] =
                    $("#maingrid").ligerGrid({
                        ...
                        dataAction: 'server',
                        url: 'manager/seller.do?method=sellerList',
                        pageSize: 20,
                        rownumbers: true,
                        width: '100%',
                        height: '100%',
        ...
        function reviewData(id) {
            ...
            $.ligerDialog.open({
                url: 'manager/customer/sellerReview.jsp?id='+row.userId, height: 500, width: 700, buttons: [
                    {
                        ...
                        $.ajax({
                            cache: true,
                            type: "POST",
                            url:"manager/seller.do?method=review",
                            data: formData,
                            async: false,
                            error: function(data) {
                                $.ligerDialog.tip({
