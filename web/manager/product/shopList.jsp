...
<head>
    ...
    <script type="text/javascript">
        ...
        function reviewData(){
            ...
            $.ligerDialog.open({
                url: 'manager/product/shopReview.jsp?id='+row.id+'&name='+encodeURI(encodeURI(row.name))+'&status='+row.status,
                height: 190,
                width: 320,
                buttons: [
                    {text: '确定', onclick: function (item, dialog) {
                        ...
                        $.ajax({
                            cache: true,
                            type: "POST",
                            url:"manager/shop.do?method=review",
                            data: formData,
                            async: false,
                            error: function(data) {
                                $.ligerDialog.tip({
        ...
        function doserch(){
            ...
            manager._setUrl("manager/shop.do?method=shopList&" + serchtxt);
    ...
    <form id='serchform'>
        <table style='width: 500px' class="bodytable1">
            <tr>
                ...
                <td>
                    <div style='width: 60px; text-align: right; float: right'>店铺状态：</div>
                </td>
                <td>
